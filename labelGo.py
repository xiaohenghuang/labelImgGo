...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def auto_label(self):
        ...
        if attention_get == QMessageBox.Yes:
            ...
            yolo_params = yaml.safe_load(open("params.yaml"))["yolo"]
            ...
            parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=yolo_params['imgsz'], help='inference size (pixels)')
            parser.add_argument('--conf-thres', type=float, default=yolo_params['conf-thres'], help='confidence threshold')
            parser.add_argument('--iou-thres', type=float, default=yolo_params['iou-thres'], help='NMS IoU threshold')
            ...
            parser.add_argument('--project', default=self.last_open_dir, help='save results to project/name')
            parser.add_argument('--name', default=yolo_params['run-name'], help='save results to project/name')
...
def get_main_app(argv=[]):
    ...
    argparser.add_argument("class_file",
                           default=os.path.join(os.path.dirname(__file__), "data", yaml.safe_load(open("params.yaml"))["labelImg"]['class-file']),
                           nargs="?")
